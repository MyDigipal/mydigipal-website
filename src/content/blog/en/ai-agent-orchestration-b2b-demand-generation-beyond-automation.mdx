...
seo:
  description: "AI agent orchestration transforms B2B demand generation in 2026. Deploy autonomous multi-agent systems that boost pipeline velocity by 41% and cut lead costs."
