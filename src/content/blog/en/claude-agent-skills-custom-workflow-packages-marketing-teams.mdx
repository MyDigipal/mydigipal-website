...
draft: false
seo:
  description: "Learn how to build Claude Agent Skills that bundle instructions, scripts and templates into reusable workflow packages for your B2B marketing team."
  title: "Claude Agent Skills: Custom Marketing Packages"
---
