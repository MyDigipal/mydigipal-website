...
C'est pour cette raison que le chantier délivrabilité et le [chantier mesure](/fr/services/tracking-reporting) sont en pratique le même projet. Si votre plateforme d'emailing est le seul système qui sait ce qui s'est passé, vous ne pouvez ni prouver que le canal fonctionne, ni le diagnostiquer quand il cesse de fonctionner.
