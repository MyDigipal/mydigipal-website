...
const FR = {
  ...
  // La question d'une ligne au-dessus du visage, au bout de dix secondes (Paul, 23/09/2026).
  inviteHome: 'Vous cherchez quoi en premier ?',
  inviteService: (service: string) => `Vous voulez un prix pour ${service} ?`,
  inviteCas: (client: string) => `Faire comme ${client} chez vous ?`,
  inviteArticle: 'On peut le faire chez vous. Je vous montre ?',
  inviteAuto: 'Un prix pour votre groupe ou votre concession ?',
  inviteContact: 'Une question avant d’écrire ?',
  inviteCalcul: 'Je vous aide à choisir vos services ?',
  ...
  // Des propositions qui promettent une réponse, pas une question de prix répétée
  // (Paul, 23/09/2026 : « faut pas être à chaque fois combien ça coûte, combien ça coûte »).
  ceQuonFait: (service: string) => `Ce qu’on fait en ${service}`,
  chezUnClient: 'Ce que ça a donné chez un client',
  votrePrix: 'Votre prix, en une question',
  votrePlan: 'Votre plan, en deux questions',
  voirAussi: 'À voir aussi',
  changerLangue: 'Lire en anglais',
...
const EN: Copy = {
  ...
  inviteHome: 'What are you looking for first?',
  inviteService: (service: string) => `Want a price for ${service}?`,
  inviteCas: (client: string) => `Do what ${client} did, at your place?`,
  inviteArticle: 'We can do it at your place. Shall I show you?',
  inviteAuto: 'A price for your group or your dealership?',
  inviteContact: 'A question before you write?',
  inviteCalcul: 'Shall I help you pick your services?',
  ...
  ceQuonFait: (service: string) => `What we do in ${service}`,
  chezUnClient: 'What it delivered for a client',
  votrePrix: 'Your price, in one question',
  votrePlan: 'Your plan, in two questions',
  voirAussi: 'Also worth a look',
  changerLangue: 'Lire en français',
