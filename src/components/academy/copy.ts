...
const FR = {
  ...
  configurateur: {
    ...
    dejaProgramme: 'J’ai déjà le programme',
    dejaProgrammeAide: 'Décochez pour n’acheter que les compléments. Votre accès au programme est vérifié sur votre adresse au moment du paiement.',
    dejaAcquis: 'Déjà acquis',
...
const EN: Jour30Copy = {
  ...
  configurateur: {
    ...
    dejaProgramme: 'I already have the programme',
    dejaProgrammeAide: 'Untick to buy the add-ons only. Your access to the programme is checked against your email address at payment.',
    dejaAcquis: 'Already yours',
